		...
		<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
			  <ul class="nav navbar-nav navbar-right">
			    ...
			    <li class="scrole"><a href="masuk.php">Masuk</a></li>
	...
	<div id="about" class="section-padding">
		<div class="container">
				<div class="page-title text-center">
					<h1>Anda telah melakukan pemilihan Ketua dan Wakil Ketua BEM FASTIKOM tahun 2017</h1>
				...
				<div class="autoplay">
					<div class="col-md-6">
						<div class="team-info">
							<div class="img-sec">
								<center><img src="images/logo.jpg" class="img-responsive"></center>
							</div>
					...
					<div class="col-md-6">
						<div class="team-info">
							<div class="img-sec">
							<p>Bila anda merasa belum melakukan pemilihan silahkan hubungi admin untuk melakukan konfirmasi</p>
						</div>
					</div>
